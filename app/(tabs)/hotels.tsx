...
export default function HotelsScreen() {
  ...
  const makkahHotels: Hotel[] = [
    { id: "1", name: "Hilton Suites Makkah", distance: "500m from Haram", price: 180, rating: 4.7, stars: 5, type: "ours", city: "Makkah" },
  ...
  const madinahHotels: Hotel[] = [
    ...
    { id: "5", name: "Pullman Madinah", distance: "400m from Nabawi", price: 190, rating: 4.6, stars: 5, type: "external", city: "Madinah" },
  ...
  const kaabaViewHotels: Hotel[] = [
    ...
    { id: "19", name: "Transcontinental Makkah", distance: "300m from Haram", price: 350, rating: 4.6, stars: 5, type: "ours", city: "Makkah" },
  ];
  ...
  const familyHotels: Hotel[] = [
    { id: "16", name: "Pullman Zamzam Makkah", distance: "400m from Haram", price: 310, rating: 4.6, stars: 5, type: "ours", city: "Makkah" },
  ...
  return (
    <View style={styles.screen}>
      ...
      <ScrollView style={styles.body} showsVerticalScrollIndicator={false}>
        ...
        {renderSection("⭐ Recommended", makkahHotels)}
        {renderSection("⭐ Top Picks", makkahHotels)}
