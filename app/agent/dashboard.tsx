...
export default function AgentDashboard() {
    ...
    useEffect(() => {
      ...
      const shareProfile = () => {
        Share.share({
          message: `Book your Umrah & Hajj with ${agent?.agency_name} through UmrahConnect! Contact us for flights, hotels and full pilgrimage packages.`,
        })
      }
    ...
    return (
        <View style={[styles.screen, { backgroundColor: theme.background }]}>
          ...
          <View style={[styles.header, { paddingTop: insets.top }]}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.headerSub}>{agent?.agency_name || "My Agency"}</Text>
            </View>
            <View style={styles.verifiedBadge}>
              <Text style={styles.verifiedText}>Agent</Text>
            </View>
          </View>
        ...
        {/* Stats */}
            ...
            <Text style={[styles.cardTitle, { color: theme.text }]}>Agency Information</Text>
            <View style={styles.infoRow}>
                <Ionicons name="briefcase-outline" size={16} color="#C9A84C" />
                <Text style={[styles.infoText, { color: theme.text }]}>{agent?.agency_name || "Not set"}</Text>
            </View>
            <View style={styles.infoRow}>
                <Ionicons name="location-outline" size={16} color="#C9A84C" />
                <Text style={[styles.infoText, { color: theme.text }]}>{agent?.agency_country || "Not set"}</Text>
            </View>
            <View style={styles.infoRow}>
                <Ionicons name="call-outline" size={16} color="#C9A84C" />
                <Text style={[styles.infoText, { color: theme.text }]}>{agent?.phone || "Not set"}</Text>
            </View>
            <View style={styles.infoRow}>
                <Ionicons name="flag-outline" size={16} color="#C9A84C" />
                <Text style={[styles.infoText, { color: theme.text }]}>{agent?.nationality || "Not set"}</Text>
            </View>
            </View>
            ...
            <TouchableOpacity style={styles.actionRow} onPress={shareProfile}>
                ...
                <View style={{ flex: 1 }}>
                <Text style={[styles.actionTitle, { color: theme.text }]}>Share My Agency</Text>
                <Text style={[styles.actionSub, { color: theme.textSecondary }]}>Share your profile with potential clients</Text>
                </View>
            ...
            >
                ...
                <View style={{ flex: 1 }}>
                <Text style={[styles.actionTitle, { color: theme.text }]}>Upgrade Plan</Text>
                <Text style={[styles.actionSub, { color: theme.textSecondary }]}>Get more clients and features</Text>
                </View>
                <Ionicons name="chevron-forward" size={18} color="#C9A84C" />
            </TouchableOpacity>
            ...
            <TouchableOpacity style={styles.actionRow} onPress={() => router.push("/hotels" as any)}>
                ...
                <View style={{ flex: 1 }}>
                <Text style={[styles.actionTitle, { color: theme.text }]}>Browse Hotels</Text>
                <Text style={[styles.actionSub, { color: theme.textSecondary }]}>Find hotels for your clients</Text>
                </View>
                <Ionicons name="chevron-forward" size={18} color="#C9A84C" />
            </TouchableOpacity>
            </View>
        ...
        <View style={[styles.subCard, { borderColor: "#C9A84C" }]}>
          <View style={styles.subRow}>
            <View>
              <Text style={styles.subPlan}>Free Trial</Text>
              <Text style={styles.subExpiry}>14 days remaining</Text>
            </View>
            <TouchableOpacity
