...
const phasesData = [
  {
    ...
    steps: [
      ...
      "Perform Ghusl (full body purification bath)",
      "Men wear two white unstitched sheets. Women wear normal modest clothing",
      "Pray 2 rakats of Ihram sunnah prayer",
      "Make the Niyyah for Hajj at the Miqat",
    ...
    tips: [
      "Keep reciting Talbiyah throughout Hajj until you stone the Jamarat",
      "Prepare mentally — Hajj is physically and spiritually demanding",
  ...
  },
  {
    ...
    steps: [
      ...
      "Perform Tawaf Al-Qudum — 7 rounds around the Kaaba",
      "Drink Zamzam water",
      "Perform Sa'i between Safa and Marwa if applicable",
      "Settle in your accommodation and rest",
    ],
    duas: [
      {
        ...
        translation: "O Allah this is Your sanctuary, so forbid my flesh to the Hellfire",
      },
    ],
    tips: [
      "Rest well — the hardest days are ahead",
      "Stay hydrated and keep water with you at all times",
      "Familiarize yourself with the area around the Haram",
    ],
  },
  {
    id: "3",
    ...
    steps: [
      "After Fajr on 8th Dhul Hijjah travel to Mina",
      "Pray Dhuhr, Asr, Maghrib, Isha and Fajr in Mina",
      "Shorten prayers to 2 rakats (Qasr) but do not combine them",
      "Spend the night in Mina in worship and dua",
      "Prepare mentally and spiritually for the Day of Arafah",
    ],
    duas: [
      {
        title: "Talbiyah — continue reciting",
    ...
    tips: [
      "Sleep early — the Day of Arafah is the most important day",
      "Keep making dhikr and Talbiyah throughout",
      "Stay in your tent and avoid unnecessary movement",
    ],
  },
  {
    id: "4",
    ...
    steps: [
      "Travel to Arafah after Fajr prayer",
      "Combine and shorten Dhuhr and Asr prayers",
      "Stand at Arafah from after Dhuhr until sunset — make constant dua",
      "Face the Qibla and raise your hands in supplication",
      "After sunset travel to Muzdalifah — do not leave before sunset",
      "Pray Maghrib and Isha combined at Muzdalifah",
    ],
    duas: [
      {
        title: "Best dua on Day of Arafah",
    ...
    tips: [
      "This is the day Allah boasts about His servants to the angels — make as much dua as possible",
      "Ask for forgiveness for yourself your family and the entire Ummah",
      "Do not waste a single moment — this day comes once a year",
    ],
  },
  {
    id: "5",
    ...
    steps: [
      "Arrive at Muzdalifah after sunset from Arafah",
      "Pray Maghrib and Isha combined",
      "Collect 49 or 70 pebbles (size of a chickpea) for the Jamarat",
      "Sleep under the open sky",
      "Pray Fajr at Muzdalifah",
      "Depart to Mina after Fajr — the weak may leave after midnight",
    ],
    duas: [
      {
        title: "Dua at Muzdalifah",
        arabic: "اللَّهُمَّ إِنَّكَ قُلْتَ ادْعُونِي أَسْتَجِبْ لَكُمْ",
        transliteration: "Allahumma innaka qulta ud'uni astajib lakum",
        translation: "O Allah You have said call upon Me and I will respond to you",
      },
    ],
    tips: [
      "The night at Muzdalifah is short — rest as much as you can",
      "Collect pebbles carefully — they should be small not large",
      "The elderly and sick may depart after midnight",
    ],
  },
  {
    id: "6",
    ...
    steps: [
      "Stone the large Jamarat (Jamarat Al-Aqabah) with 7 pebbles",
      "Say Allahu Akbar with each throw",
      "Perform the sacrifice (Udhiyah/Hady)",
      "Shave head (men) or trim hair (women) — exit partial Ihram",
      "Perform Tawaf Al-Ifadah (obligatory Tawaf)",
    ...
    duas: [
      {
        ...
        translation: "Allah is the Greatest — said with each pebble thrown",
      },
    ],
    tips: [
      "Stone the Jamarat early morning to avoid crowds",
      "Do the actions in order — stoning then sacrifice then shaving then Tawaf",
      "After shaving all Ihram restrictions are lifted except marital relations until Tawaf",
    ],
  ...
  },
  {
    ...
    steps: [
      "Stone all three Jamarat each day — small, medium and large",
      "Throw 7 pebbles at each Jamarat — 21 pebbles per day",
      "Stone after Dhuhr time each day",
      "Those leaving early may depart on the 12th before sunset",
      "Those staying must stone on the 13th as well",
    ...
    tips: [
      "Stone after Dhuhr — before Dhuhr is not valid on these days",
      "If you leave on the 12th depart before sunset otherwise you must stone on the 13th",
      "Make abundant dhikr and dua during these blessed days",
    ],
  },
  {
    id: "8",
    ...
    steps: [
      "Perform 7 rounds of Tawaf around the Kaaba",
      "This should be the last thing you do before leaving Makkah",
      "Do not stay in Makkah long after the farewell Tawaf",
      "Make dua and bid farewell to the Kaaba",
      "Leave Makkah with a heavy heart hoping to return",
    ],
    duas: [
      {
        title: "Dua when leaving Makkah",
        arabic: "اللَّهُمَّ إِنَّ هَذَا الْبَيْتَ بَيْتُكَ وَالْعَبْدُ عَبْدُكَ",
        transliteration: "Allahumma innal bayta baytuka wal abdu abduka",
        translation: "O Allah this house is Your house and the servant is Your servant",
      },
    ],
    tips: [
      "The farewell Tawaf should be your last act before departing",
      "Women in their menstrual cycle are excused from Tawaf Al-Wadaa",
      "Make abundant dua — you may not return to this blessed place",
    ],
  },
  {
    id: "9",
    ...
    steps: [
      "Make abundant dua — your Hajj is complete",
      "Return home and maintain the spiritual transformation",
      "Keep the good habits you developed during Hajj",
      "Share the experience with your family and community",
      "Continue making dua for acceptance",
    ],
    duas: [
      {
    ...
    tips: [
      "A Mabrur Hajj has no reward except Jannah",
      "Maintain your good deeds after Hajj — this is a sign of acceptance",
  ...
  const [isCompleted, setIsCompleted] = useState(false)
   ...
   useEffect(() => {
    const checkProgress = async () => {
      const progress = await getHajjProgress()  // ← changed
      ...
      <View style={{ marginHorizontal: 20, marginBottom: 20 }}>
        {nextPhase ? (
          <TouchableOpacity
            ...
            onPress={() => router.push(`/hajj/${nextPhase.id}`)}
          >
          ...
          <View style={styles.completionBox}>
            ...
            <Text style={styles.completionText}>
              May Allah accept your Hajj and make you a Mabrur Hajj. Ameen.
            </Text>
          </View>
        )}
      </View>
