...
const phasesData = [
  {
    ...
    steps: ["Arrive in Madinah with the intention of visiting Masjid An-Nabawi", "Pray in Masjid An-Nabawi — one prayer here equals 1000 prayers elsewhere", "Visit Riyad Al Jannah (the Garden of Paradise) between the Prophet's grave and his pulpit", "Send salawat upon the Prophet ﷺ at his grave", "Visit the graves of the companions at Jannat Al Baqi", "Visit Masjid Quba — praying 2 rakats here equals the reward of Umrah"],
    duas: [{ title: "Dua upon entering Masjid An-Nabawi", arabic: "اللَّهُمَّ افْتَحْ لِي أَبْوَابَ رَحْمَتِكَ", transliteration: "Allahumma iftah li abwaba rahmatik", translation: "O Allah, open for me the gates of Your mercy" }, { title: "Salawat upon the Prophet ﷺ", arabic: "اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ وَعَلَى آلِ مُحَمَّدٍ", transliteration: "Allahumma salli ala Muhammad wa ala ali Muhammad", translation: "O Allah, send blessings upon Muhammad and the family of Muhammad" }],
    tips: ["Visit Riyad Al Jannah early morning to avoid crowds", "Women should cover fully including face covering recommended near the grave", "Stay for at least 2-3 days to benefit fully from the blessings of Madinah"],
  },
  {
    ...
    steps: ["Perform Ghusl (full body purification bath) with the intention of Ihram", "Men wear two white unstitched sheets (izar and rida). Women wear their normal modest clothing", "Apply perfume to your body only — not to the Ihram garments", "Pray 2 rakats of Ihram sunnah prayer", "Make the Niyyah (intention) for Umrah at the Miqat", "Begin reciting the Talbiyah loudly (men) or quietly (women)"],
    duas: [{ title: "Niyyah for Umrah", arabic: "لَبَّيْكَ اللَّهُمَّ عُمْرَةً", transliteration: "Labbayka Allahumma Umratan", translation: "Here I am O Allah, for Umrah" }, { title: "Talbiyah", arabic: "لَبَّيْكَ اللَّهُمَّ لَبَّيْكَ، لَبَّيْكَ لَا شَرِيكَ لَكَ لَبَّيْكَ، إِنَّ الْحَمْدَ وَالنِّعْمَةَ لَكَ وَالْمُلْكَ، لَا شَرِيكَ لَكَ", transliteration: "Labbayk Allahumma labbayk, labbayk la sharika laka labbayk, innal hamda wan-ni'mata laka wal-mulk, la sharika lak", translation: "Here I am O Allah, here I am. Here I am, You have no partner, here I am. Verily all praise, grace and sovereignty belong to You. You have no partner." }],
    tips: ["Once in Ihram avoid cutting hair, nails, using perfume, or marital relations", "Keep reciting Talbiyah until you begin Tawaf", "If you accidentally violate Ihram rules, consult a scholar about the expiation"],
  ...
  },
  {
    ...
    steps: ["Enter Makkah reciting the dua for entering a city", "Enter Masjid Al-Haram with your right foot and recite the masjid entry dua", "When you first see the Kaaba — stop and make dua, this is a moment when duas are accepted", "Stop reciting the Talbiyah as you begin Tawaf", "Proceed to the Kaaba to begin Tawaf"],
    duas: [{ title: "Dua upon entering Makkah", arabic: "اللَّهُمَّ هَذَا حَرَمُكَ وَأَمْنُكَ فَحَرِّمْنِي عَلَى النَّارِ", transliteration: "Allahumma hadha haramuka wa amnuka faharrimni alan-nar", translation: "O Allah this is Your sanctuary and Your place of safety, so forbid my flesh to the Hellfire" }, { title: "Dua upon first seeing the Kaaba", arabic: "اللَّهُمَّ أَنْتَ السَّلَامُ وَمِنْكَ السَّلَامُ فَحَيِّنَا رَبَّنَا بِالسَّلَامِ", transliteration: "Allahumma Anta-s-Salamu wa minka-s-salamu fa hayyina Rabbana bis-salam", translation: "O Allah You are Peace and from You comes peace, so greet us our Lord with peace" }],
    tips: ["Take your time when you first see the Kaaba — make as much dua as you can", "This moment is known to be one of the best times for dua acceptance", "Enter the masjid calmly with full focus and presence of heart"],
  ...
  },
  {
    ...
    steps: ["Make sure you are in a state of wudu (ablution) before starting", "Start at the Black Stone (Hajr Al-Aswad) — touch it or point to it saying 'Bismillah Allahu Akbar'", "Keep the Kaaba on your LEFT side at all times", "Complete 7 rounds — each round starts and ends at the Black Stone", "Men should do Idtiba (right shoulder exposed) and Raml (brisk walk) in the first 3 rounds", "After 7 rounds pray 2 rakats behind Maqam Ibrahim", "Drink Zamzam water"],
    duas: [{ title: "Starting Tawaf at the Black Stone", arabic: "بِسْمِ اللَّهِ اللَّهُ أَكْبَرُ", transliteration: "Bismillahi Allahu Akbar", translation: "In the name of Allah, Allah is the Greatest" }, { title: "Dua between Yemeni corner and Black Stone", arabic: "رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الْآخِرَةِ حَسَنَةً وَقِنَا عَذَابَ النَّارِ", transliteration: "Rabbana atina fid-dunya hasanatan wa fil-akhirati hasanatan wa qina adhaban-nar", translation: "Our Lord give us good in this world and good in the hereafter and save us from the punishment of the Fire" }],
    tips: ["There is no specific dua required for each round — make any dua from your heart", "If you lose count of your rounds, assume the lesser number", "Tawaf can be done on the ground floor or upper levels if crowded"],
  ...
  },
  {
    ...
    steps: ["Proceed to Mount Safa after completing Tawaf and drinking Zamzam", "Climb Safa, face the Kaaba and make dua", "Walk towards Marwa — men should run between the green lights", "Climb Marwa, face the Kaaba and make dua", "This is ONE trip — you need 7 trips total", "Safa to Marwa = 1, Marwa to Safa = 2, and so on until you end at Marwa on trip 7"],
    duas: [{ title: "Dua at Mount Safa", arabic: "إِنَّ الصَّفَا وَالْمَرْوَةَ مِنْ شَعَائِرِ اللَّهِ", transliteration: "Innas-Safa wal-Marwata min sha'a'irillah", translation: "Indeed Safa and Marwa are among the symbols of Allah" }, { title: "Dua facing the Kaaba at Safa and Marwa", arabic: "اللَّهُ أَكْبَرُ، اللَّهُ أَكْبَرُ، اللَّهُ أَكْبَرُ، وَلِلَّهِ الْحَمْدُ", transliteration: "Allahu Akbar, Allahu Akbar, Allahu Akbar, wa lillahil hamd", translation: "Allah is the Greatest, Allah is the Greatest, Allah is the Greatest, and to Allah belongs all praise" }],
    tips: ["Wudu is recommended but not required for Sa'i", "Count your trips carefully — you must end at Marwa on the 7th", "Make personal dua in your own language — Allah hears every language"],
  ...
  },
  {
    ...
    steps: ["Men — shave the entire head (Halq) which is more rewarding, or cut hair from all parts (Taqsir)", "Women — cut a fingertip's length from the ends of their hair only", "After cutting hair you exit Ihram and all restrictions are lifted", "Change out of Ihram garments into normal clothes", "Your Umrah is now complete — Alhamdulillah!"],
    duas: [{ title: "Dua after completing Umrah", arabic: "اللَّهُمَّ تَقَبَّلْ مِنَّا إِنَّكَ أَنْتَ السَّمِيعُ الْعَلِيمُ", transliteration: "Allahumma taqabbal minna innaka Anta-s-Sami'ul-'Alim", translation: "O Allah accept from us, indeed You are the All-Hearing the All-Knowing" }],
    tips: ["Shaving the head (Halq) is more rewarding than trimming for men", "Women should not shave — only trim a small amount", "Make dua for acceptance of your Umrah immediately after"],
  },
  {
    ...
    steps: ["Make abundant dua — your Umrah is now complete", "You may now perform optional Tawaf (Tawaf An-Nafl) as many times as you wish", "Visit the Kaaba at different times — night Tawaf is especially beautiful", "Spend time in dua, Quran recitation and dhikr", "If performing Hajj — await the days of Hajj in a state of gratitude"],
    ...
    tips: ["Tawab Al-Nafl (optional Tawaf) is highly recommended during your stay", "Spend as much time as possible in the Haram — every step is rewarded", "Make dua for yourself family and the entire Ummah"],
  },
]
