/**
 * Authentic Morning & Evening Adhkar — fixed content (no API).
 * Arabic text stays Arabic always. Transliteration + English translation are full text.
 */
...
export const morningAdhkar = [
  {
    ...
    transliteration:
      "A'udhu billahi minash-shaytanir-rajeem. Allahu la ilaha illa Huwal-Hayyul-Qayyum. La ta'khudhuhu sinatun wa la nawm. Lahu ma fis-samawati wa ma fil-ard. Man dhal-ladhi yashfa'u 'indahu illa bi-idhnih. Ya'lamu ma bayna aydihim wa ma khalfahum, wa la yuhituna bi-shay'im-min 'ilmihi illa bi-ma sha'. Wasi'a kursiyyuhus-samawati wal-ard, wa la ya'uduhu hifzuhuma, wa Huwal-'Aliyyul-'Azeem.",
    translation:
      "I seek refuge in Allah from the accursed Satan. Allah — there is no god except Him, the Ever-Living, the Sustainer of all existence. Neither drowsiness nor sleep overtakes Him. To Him belongs whatever is in the heavens and whatever is on the earth. Who is it that can intercede with Him except by His permission? He knows what is before them and what is behind them, and they encompass nothing of His knowledge except what He wills. His Kursi extends over the heavens and the earth, and their preservation does not tire Him. And He is the Most High, the Most Great.",
    count: 1,
    source: "البقرة: ٢٥٥",
  ...
  },
  {
    ...
    transliteration:
      "Bismillahir-Rahmanir-Raheem. Qul Huwallahu Ahad. Allahus-Samad. Lam yalid wa lam yulad. Wa lam yakun lahu kufuwan ahad.",
    translation:
      "In the name of Allah, the Most Gracious, the Most Merciful. Say: He is Allah, the One. Allah, the Eternal Refuge. He neither begets nor is born, and there is none comparable to Him.",
    count: 3,
    source: "سورة الإخلاص",
  ...
  },
  {
    ...
    translation:
      "In the name of Allah, the Most Gracious, the Most Merciful. Say: I seek refuge in the Lord of daybreak, from the evil of what He created, from the evil of darkness when it settles, from the evil of the blowers in knots, and from the evil of an envier when he envies.",
    count: 3,
    source: "سورة الفلق",
  ...
  },
  {
    ...
    translation:
      "In the name of Allah, the Most Gracious, the Most Merciful. Say: I seek refuge in the Lord of mankind, the King of mankind, the God of mankind, from the evil of the retreating whisperer, who whispers into the breasts of mankind — from among the jinn and mankind.",
    count: 3,
    source: "سورة الناس",
    benefit: "حفظ من الوسواس والشيطان",
  },
  {
    id: 5,
    arabic:
    ...
    transliteration:
      "Asbahna wa asbahal-mulku lillah, walhamdu lillah, la ilaha illallahu wahdahu la sharika lah, lahul-mulku wa lahul-hamdu wa Huwa 'ala kulli shay'in qadeer. Rabbi as'aluka khayra ma fi hadhal-yawmi wa khayra ma ba'dah, wa a'udhu bika min sharri ma fi hadhal-yawmi wa sharri ma ba'dah.",
    translation:
      "We have entered the morning and the whole kingdom belongs to Allah. All praise is for Allah. There is no god but Allah alone, with no partner. To Him belongs the dominion and to Him belongs all praise, and He is over all things capable. My Lord, I ask You for the good of this day and the good that follows it, and I seek refuge in You from the evil of this day and the evil that follows it.",
    count: 1,
    source: "صحيح مسلم",
    benefit: "دعاء الصباح المأثور",
  },
  {
    id: 6,
    arabic:
  ...
  },
  {
    ...
    translation:
      "O Allah, I have entered the morning and I call You to witness, and I call the bearers of Your Throne, Your angels, and all of Your creation to witness, that You are Allah — there is no god but You alone, with no partner, and that Muhammad is Your servant and Your Messenger.",
    count: 4,
    source: "سنن أبي داود",
  ...
  },
  {
    ...
    count: 3,
    source: "سنن أبي داود",
    benefit: "العافية في البدن والسمع والبصر",
  },
  {
    id: 10,
    arabic:
...
function toEveningArabic(arabic) {
  return arabic
    .replace(/أَصْبَحْنَا/g, "أَمْسَيْنَا")
    .replace(/أَصْبَحْتُ/g, "أَمْسَيْتُ")
    .replace(/هَذَا الْيَوْمِ/g, "هَذِهِ اللَّيْلَةِ")
    .replace(/الْيَوْمِ/g, "اللَّيْلَةِ")
}

/** Evening-specific overrides where a simple word swap is not enough */
const eveningOverrides = {
  5: {
    arabic:
      "أَمْسَيْنَا وَأَمْسَى الْمُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ، لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ، رَبِّ أَسْأَلُكَ خَيْرَ مَا فِي هَذِهِ اللَّيْلَةِ وَخَيْرَ مَا بَعْدَهَا، وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِي هَذِهِ اللَّيْلَةِ وَشَرِّ مَا بَعْدَهَا",
    transliteration:
      "Amsayna wa amsal-mulku lillah, walhamdu lillah, la ilaha illallahu wahdahu la sharika lah, lahul-mulku wa lahul-hamdu wa Huwa 'ala kulli shay'in qadeer. Rabbi as'aluka khayra ma fi hadhihil-laylati wa khayra ma ba'daha, wa a'udhu bika min sharri ma fi hadhihil-laylati wa sharri ma ba'daha.",
    translation:
      "We have entered the evening and the whole kingdom belongs to Allah. All praise is for Allah. There is no god but Allah alone, with no partner. To Him belongs the dominion and to Him belongs all praise, and He is over all things capable. My Lord, I ask You for the good of this night and the good that follows it, and I seek refuge in You from the evil of this night and the evil that follows it.",
    benefit: "دعاء المساء المأثور",
  },
  6: {
    arabic:
  ...
  8: {
    ...
    translation:
      "O Allah, I have entered the evening and I call You to witness, and I call the bearers of Your Throne, Your angels, and all of Your creation to witness, that You are Allah — there is no god but You alone, with no partner, and that Muhammad is Your servant and Your Messenger.",
    benefit: "أعتق ربعه من النار",
  },
  1: {
...
export const eveningAdhkar = morningAdhkar.map((item) => {
  const override = eveningOverrides[item.id] || {}
  return {
    ...item,
    arabic: override.arabic || toEveningArabic(item.arabic),
    transliteration: override.transliteration || item.transliteration,
    translation: override.translation || item.translation,
    benefit: override.benefit || item.benefit,
  }
})

export function getAdhkarList(period) {
  return period === "evening" ? eveningAdhkar : morningAdhkar
}
